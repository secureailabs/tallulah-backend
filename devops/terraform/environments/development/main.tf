...
module "container_app_backend" {
  ...
  docker_image                = format("%s/%s", var.container_registry_server, "tallulah/backend:v0.1.0_1fa689c")
...
module "container_app_rabbit_mq" {
  ...
  resource_group_name         = module.resource_group.resource_group_name
  container_app_env_id        = module.container_apps_env.container_app_environment_id
  docker_image                = format("%s/%s", var.container_registry_server, "tallulah/rabbitmq:v0.1.0_1fa689c")
  container_registry_server   = var.container_registry_server
  container_registry_username = var.container_registry_username
  container_registry_password = var.container_registry_password
...
module "container_app_logstash" {
  ...
  resource_group_name         = module.resource_group.resource_group_name
  container_app_env_id        = module.container_apps_env.container_app_environment_id
  docker_image                = format("%s/%s", var.container_registry_server, "tallulah/logstash:v0.1.0_1fa689c")
  container_registry_server   = var.container_registry_server
  container_registry_username = var.container_registry_username
  container_registry_password = var.container_registry_password
